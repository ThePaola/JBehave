package main.java.amazon.steps;
...
public class AmazonDotComSteps {
    ...
    public AmazonDotComSteps(PageFactory pageFactory){
    ...
    @Given("I am shopping for a $thing in $section on Amazon.com")
    public void shoppingForSomethingOnAmazonDotCom(String thing, String section) {
        home.go(section);
        home.search(thing);
    }

    @Given("I am on Amazon.com")
    public void homepageOnAmazonDotCom() {
        home.go();
    }

    @Given("I am searching on Amazon.com")
    public void advancedSearchingOnAmazonDotCom() {
        advancedSearch.go();
    }
    ...
    @Composite(steps = { "When I want to buy something from Amazon.com", "When I want to browse the treasury",
            "When I choose the first treasury gallery" })
    public void browseToFirstTreasuryGallery() {
    }

    @When("I want to buy something from Amazon.com")
