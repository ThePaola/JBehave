...
@UsingSpring(resources = { "amazon-steps.xml" })
public class AnnotatedAmazonDotComStories extends InjectableEmbedder {

    public AnnotatedAmazonDotComStories() {
    }
    ...
    public void run() throws Throwable {
        ...
        StoryReporterBuilder reporterBuilder = new StoryReporterBuilder()
                .withCodeLocation(codeLocationFromClass(AmazonDotComStories.class)).withFailureTrace(true)
